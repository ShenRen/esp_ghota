...
function(esptool_rename_bin new_name)
    add_custom_target(${CMAKE_PROJECT_NAME}_rename_bin ALL
        DEPENDS gen_project_binary
        COMMAND "${CMAKE_COMMAND}" -E copy "${CMAKE_PROJECT_NAME}.bin" "${new_name}.bin"
        WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
        COMMENT "Rename binary image to: ${new_name}.bin"
        )
    add_dependencies(app ${CMAKE_PROJECT_NAME}_rename_bin)
endfunction()